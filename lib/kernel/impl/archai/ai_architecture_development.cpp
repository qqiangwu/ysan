...
const std::string& AI::Arch_development_ai::id() const
{
    static std::string id_ = "core::develop";
    return id_;
}

void AI::Arch_development_ai::work_imp(const Timeline& tl)
{
...
void AI::Arch_development_ai::work_wen()
{
...
void AI::Arch_development_ai::work_wu()
{
